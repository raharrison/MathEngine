...
public class ConversionEngineTimeTest extends ConversionEngineTest {
    ...
    public void testTimes() {
        ...
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Nanosecond", "Seconds", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Nanosecond", "Minutes", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Nanosecond", "Hours", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Nanosecond", "Days", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Nanosecond", "Weeks", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Nanosecond", "Months", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Nanosecond", "Years", PLACES), 0.0);
        ...
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Microsecond", "Minutes", PLACES), 0.0);
        assertEquals(7.944444444444445E-10, engine.convertAsDouble(AMOUNT, "Microsecond", "Hours"), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Microsecond", "Days", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Microsecond", "Weeks", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Microsecond", "Months", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Microsecond", "Years", PLACES), 0.0);
        ...
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Millisecond", "Days", PLACES), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Millisecond", "Weeks", PLACES), 0.0);
        assertEquals(1.0882800608828006E-9, engine.convertAsDouble(AMOUNT, "Millisecond", "Months"), 0.0);
        assertEquals(0.0, engine.convertAsDouble(AMOUNT, "Millisecond", "Years", PLACES), 0.0);
        ...
        assertEquals(1.0E-7, engine.convertAsDouble(AMOUNT, "Second", "Years", PLACES), 0.0);
