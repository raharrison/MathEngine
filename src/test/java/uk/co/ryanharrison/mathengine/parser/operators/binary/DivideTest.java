...
class DivideTest {
    ...
    void divideDoubleAndMatrix() {
        ...
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(23 / 23d), new NodeDouble(23 / 45d)}, atIndex(0));
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(23 / 45d), new NodeDouble(23 / 23d)}, atIndex(1));
    }
    ...
    void divideVectorAndMatrix() {
        ...
        assertThat(result).isInstanceOf(NodeMatrix.class);
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(23 / 23d), new NodeDouble(45 / 45d)}, atIndex(0));
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(23 / 45d), new NodeDouble(45 / 23d)}, atIndex(1));
    }
    ...
    void divideTwoMatrixSameType() {
        ...
        assertThat(result).isInstanceOf(NodeMatrix.class);
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(23d / 23), new NodeDouble(45 / 45d)}, atIndex(0));
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(45 / 45d), new NodeDouble(23d / 23)}, atIndex(1));
    }
    ...
    void divideTwoMatrixDifferentType() {
        ...
        assertThat(result).isInstanceOf(NodeMatrix.class);
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(23d / (1 / 8d)), new NodeDouble(45d / (3 / 8d))}, atIndex(0));
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(45d / (3 / 8d)), new NodeDouble(23d / (1 / 8d))}, atIndex(1));
    }
    ...
    void divideMatrixAndDouble() {
        ...
        assertThat(result).isInstanceOf(NodeMatrix.class);
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(23 / 23d), new NodeDouble(45 / 23d)}, atIndex(0));
        assertThat(((NodeMatrix) result).getValues()).contains(
                new Node[]{new NodeDouble(45 / 23d), new NodeDouble(23 / 23d)}, atIndex(1));
    }
