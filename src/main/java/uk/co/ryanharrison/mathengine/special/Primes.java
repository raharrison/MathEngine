...
public final class Primes {
     ...
     * number
     *
     * @param n The number to generate the next prime after
     ...
     * specified number
     *
     * @param n The number to generate the next prime before
     ...
     *
     * @param n The number to generate the prime factors of
