...
public final class FDistribution extends ContinuousProbabilityDistribution {
     ...
     * and nu2
     *
     * @param nu1 The first parameter
     * @param nu2 The second parameter
     * @throws IllegalArgumentException If nu1 or nu2 are less than or equal to zero
     */
     ...
     * {@inheritDoc}
     *
     * @throws IllegalArgumentException If f is less than zero
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @throws IllegalArgumentException If f is less than or equal to zero
     */
    @Override
