...
public final class BinomialDistribution extends DiscreteProbabilityDistribution {
     ...
     * @param pe The probability
     * @throws IllegalArgumentException If n is less than or equal to zero. If pe is not between
     *                                  zero and one
     */
     ...
     * {@inheritDoc}
     *
     * @throws IllegalArgumentException If k is not greater than zero
     */
    @Override
