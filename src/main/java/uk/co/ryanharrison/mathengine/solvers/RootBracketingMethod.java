...
public abstract class RootBracketingMethod extends EquationSolver {
     ...
     * {@inheritDoc}
     *
     * @throws IllegalArgumentException If the bounds do not surround a root
     */
    @Override
     ...
     * @param lower    The lower bound of the bracket
     * @param upper    The upper bound of the bracket
     ...
     *
     * @param lowerBound The new lower bound of the bracket
     */
     ...
     *
     * @param upperBound The new upper bound of the bracket
     */
