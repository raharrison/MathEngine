...
public final class Vector {
     ...
     *
     * @param vector The string representation of the vector. This is a curly brace
     ...
     * @throws IllegalArgumentException If either vector has a size that is not three
     */
     ...
     *
     * @param vector The other vector to test
     ...
     *
     * @throws IllegalArgumentException If the normal of this vector is zero
     */
     ...
     *
     * @param k The number to raise to
     * @return A new {@link Vector} with each number of the current vector
     ...
     *
     * @param vector The vector to raise to
     * @return The result of this vector ^ the parameter vector
     */
